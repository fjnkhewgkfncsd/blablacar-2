...
class HomeContent extends StatelessWidget {
  ...
  void onRidePrefSelected(
    ...
    homeViewModel.onRidePreferenceSelected(selectedPreference);
          ...
          child: Column(
            ...
            children: [
              ...
              BlaRidePreferencePicker(
                ...
                onRidePreferenceSelected: (ridePref) =>
                    onRidePrefSelected(ridePref, context),
              ),
  ...
  Widget _buildHistory(BuildContext context) {
    ...
    List<RidePreference> history = homeViewModel.historyRidePreferences;
